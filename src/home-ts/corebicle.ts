...
const scrollUpAnimation = document.querySelectorAll<HTMLElement>('.scroll-animate');
const scrollSideAnimation = document.querySelectorAll<HTMLDivElement>('.scroll-animate-side');
