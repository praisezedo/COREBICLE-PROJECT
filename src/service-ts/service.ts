const scrollAnimationRight = document.querySelectorAll<HTMLElement>('.animate-scroll-animate-right');
const scrollAnimationUp = document.querySelectorAll<HTMLElement>('.animate-scroll-animate-up');
